...
Matched projects: **65 / 75**
Unmatched projects: **10 / 75**
...
- `GGM-69-TRU` Trump Tower 2
- `GGM-MAN-GIC` Smartworld GIC
- `GGM-113-STA` M3M St Andrews
- `GGM-63A-KAI` TARC Kailasa
- `GGM-104-LEV` Satya Levante
- `GGM-113-MIR` M3M Mira Vita
- `GGM-45-ELE` Experion Elements

## Manual Review

- `GGM-69-TRU` Trump Tower 2 -> https://reratracker.com/trump-residences-smartworld-in-gurugram-by-riverday-infrastructure-private-limited-rtid4256 (Low confidence manual link (score 0.00))
- `GGM-MAN-GIC` Smartworld GIC -> https://reratracker.com/m3m-forestia-east-i-in-gurugram-by-m3m-india-infrastructures-private-limited-rtid5422 (Low confidence manual link (score 0.00))
- `GGM-63A-KAI` TARC Kailasa -> https://reratracker.com/tarc-ishva-in-gurugram-by-tarc-limited-rtid4187 (Update name to TARC Ishva)
- `GGM-104-LEV` Satya Levante -> https://reratracker.com/levante-residences-in-gurugram-by-sv-infra-management-solutions-pvt-ltd-formerly-known-as-sv-infra-management-solutions-llp-rtid5393 (Low confidence manual link (score 0.00))
- `GGM-113-MIR` M3M Mira Vita -> https://reratracker.com/m3m-elie-saab-at-scda-in-gurugram-by-metro-education-welfare-private-limited-rtid5246 (Update name to M3M Elie Saab)
- `GGM-45-ELE` Experion Elements -> https://reratracker.com/experion-the-trillion-in-gurugram-by-experion-developers-private-limited-rtid4244 (update name to Experion Trillion)
