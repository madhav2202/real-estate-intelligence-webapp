...
| RERA registration number | `reraNumber` | 63 | 12 | HRERA / ReraTracker | stable |
| RERA possession date | `reraPossession` | 49 | 26 | HRERA / ReraTracker | stable |
...
| Land area | `reraDetails.landArea` | 58 | 17 | HRERA / ReraTracker | stable |
| Licensed land | `reraDetails.totalLicensedLand` | 57 | 18 | HRERA / ReraTracker | stable |
| Total towers | `reraDetails.totalTowers` | 40 | 35 | HRERA / ReraTracker | stable |
| Total units | `reraDetails.totalUnits` | 48 | 27 | HRERA / ReraTracker | stable |
...
| Total floors | `reraDetails.totalFloors` | 44 | 31 | HRERA / ReraTracker | stable |
...
| Size range | `reraDetails.sizes` | 58 | 17 | HRERA / ReraTracker | stable |
| Start date | `reraDetails.startDate` | 47 | 28 | HRERA / ReraTracker | stable |
| Completion date | `reraDetails.completionDate` | 44 | 31 | HRERA / ReraTracker | stable |
| ReraTracker source URL | `reraDetails.sourceUrl` | 58 | 17 | ReraTracker | stable |
...
| `GGM-103-WES` | Whiteland Westin Residences | 20 |
